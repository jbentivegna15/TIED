...
import UserPageBox from './UserPageBox';
...
const Routes = () => (
  <Router>
    <div>
      ...
      <Route exact path={"/users/:user_id"} component={() => <UserPageBox url={`${APICONST}/users`}/>}/>
      <Route exact path={"/createGroup"} component={() => <GroupBox url={`${APICONST}/groups`} pollInterval={2000}/>}/>
